          ...
          if (JSON.stringify(has) === '{}') {
            ...
            if (has.article.id) {
              ...
              if (has.article.ucreated) {
                ...
                availability += '<p><b>This article is not freely available</b></p>. However someone has already requested the author freely share this article<a class="btn btn-action" href="/request/' + has.article.id + '?support=true">Notify me</a></p>';
              }
            } else {
