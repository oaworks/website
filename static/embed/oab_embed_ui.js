        ...
        $.ajax({
          ...
          success: function(iia) {
            try {
              ...
              if (eurl) {
                var ex = 'Here is an example:<br> <a href ="' + eurl + '?doi=10.1016/j.cplett.2012.10.045&email=something@university.edu" target="_blank"> '+ eurl +'?doi=10.1016/j.cplett.2012.10.045&email=something@university.edu</a>.<br><br>Any DOI will work, and you don’t need to include an email if you don’t have it.';
                $('#embeddedexample').html(ex).show();
              } else {
