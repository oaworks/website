...
_oab = (opts) ->
  ...
  this.state ?= false # if true, the embed will try to add page state changes to the browser state manager
  this.config ?= {}
  ...
  if this.state
    try
      if pop?
        ...
        else if this.data?.doi? or this.data?.title? or this.data?.url?
